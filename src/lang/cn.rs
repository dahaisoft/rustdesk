...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "下面的 ID 和密码告诉对方。"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 新悦电脑 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "服务正在运行"),
        ("Service is not running", "服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接"),
        ("Control Remote Desktop", "电脑组装 硬件升级 网络维护 TEL:17625370078"),
        ("Transfer file", "请勿点击这里"),
        ("Connect", "请勿点击这里"),
        ...
        ("Website", "新悦电脑官网"),
        ("About", "关于"),
        ("Slogan_tip", "电脑组装 硬件升级 网络维护 打印机维修 监控安装维护维修"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "目前是免安装运行，由于系统权限问题，某些情况下可能无法控制鼠标键盘，请点击下面的按钮将安装到系统，从而规避上述问题。"),
        ...
        ("setup_server_tip", "电脑组装 硬件升级 网络维护 TEL:17625370078"),
        ...
        ("Maximize", "最大化"),
        ("Your Device", "你的设备"),
        ("empty_recent_tip", "电脑是否卡顿 是时候升级硬件了 TEL:17625370078"),
        ("empty_favorite_tip", "电脑是否卡顿 是时候升级硬件了 TEL:17625370078"),
        ("empty_lan_tip", "电脑是否卡顿 是时候升级硬件了 TEL:17625370078"),
        ("empty_address_book_tip", "电脑是否卡顿 是时候升级硬件了 TEL:17625370078"),
        ("eg: admin", "例如：admin"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("id_input_tip", "电脑组装 硬件升级 网络维护 打印机维修 监控安装维护维修"),
