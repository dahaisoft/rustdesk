...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "新悦电脑远程协助"),
        ("desk_tip", "将下面的ID和密码告知对方"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 新悦电脑专用 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "新悦电脑远程协助持续服务中"),
        ("Service is not running", "服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接"),
        ("Control Remote Desktop", "经营：电脑组装 电脑维修 网络维护 打印机维修 电脑升级 专业软件安装 监控安防等"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "经营：电脑组装 电脑维修 网络维护 打印机维修 电脑升级 专业软件安装 监控安防等 联系电话：17625370078"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "经营：电脑组装 电脑维修 网络维护 打印机维修 电脑升级 远程协助（收费），你正在运行免安装版本，由于系统权限问题，请点击下面的按钮安装到系统。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 新悦电脑 \"控制\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 新悦电脑 \"控制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("setup_server_tip", "新悦电脑专用远程协助 点击查看 TEL:17625370078(微)"),
        ...
        ("Strong", "强"),
        ("Switch Sides", "反转访问方向"),
        ("Please confirm if you want to share your desktop?", "请确认是否确认被协助？"),
        ("Display", "显示"),
        ...
        ("id_input_tip", "经营：电脑组装 电脑维修 网络维护 打印机维修 电脑升级 专业软件安装 监控安防等 联系电话：17625370078"。"),
        ...
        ("About RustDesk", "关于 RustDesk(新悦电脑专用)"),
